...
public class KamarController {
    public void insertData(String nama_kamar, String ukuran_kamar, String ket_kamar){
        KamarEntity Kamar = new KamarEntity();
        Kamar.setNama_kamar(nama_kamar);
        Kamar.setUkuran(ukuran_kamar);
        Kamar.setKet_kamar(ket_kamar);
    ...
    Object[] kolom = {"ID","NAMA KAMAR","UKURAN KAMAR","KET KAMAR","STATUS"};
